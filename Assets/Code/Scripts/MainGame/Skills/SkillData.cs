...
public class SkillData : MonoBehaviour
{
    ...
    public void Initialize()
    {
        ...
        Skill skill0 = new Skill(0, SkillEnum.EmotionalInsight, "Emotional Insight", "Recognizing and managing one's own and others' emotions, fostering healthy relationships and making conscientious decisions.", "Kill all enemies around the IA's mate", 1, true, false, 5, skillImages[0], new SkillCommand(emotionalInsightSkill));
